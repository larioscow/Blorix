export const ImgBg = () => {
  return (
    <div className="flex justify-center items-center h-[calc(100vh-72px)] absolute">
      <div className="rounded-4xl grid grid-cols-1 place-items-center absolute top-0 z-[-10] w-[calc(100vw-20px)] sm:w-[calc(100vw-40px)] h-[calc(100vh-100px)] overflow-clip animate-in">
